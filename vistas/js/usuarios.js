...
$(".tablas").on("click", ".btnEditarUsuario", function(){
	...
	$.ajax({
		...
		success: function(respuesta){
			...
			$("#editardiasDespacho").val(respuesta["diasDespacho"]);
...
$(".tablas").on("click", ".btnEliminarUsuario", function(){
  ...
  swal({
    ...
    if(result.value){
      ...
      window.location = "index.php?ruta=usuarios&idUsuario="+idUsuario+"&usuario="+usuario+"&fotoUsuario="+fotoUsuario+"&Idrut="+Idrut;
