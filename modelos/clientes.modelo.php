...
class ModeloClientes{
	...
	static public function mdlMostrarClientes($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT  * from clientes2 where trim( $item)=trim(:$item) ");
	...
	static public function mdlMostrarSucursales($tabla, $item, $valor){
		...
		if($item != null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT distinct sucursal FROM clientes2 WHERE descripcion = :$item ORDER BY sucursal");
