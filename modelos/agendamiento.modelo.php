...
class ModeloClientes{
	...
	static public function mdlIngresarAgendamiento($tabla, $datos){
	...
	static public function mdlMostrarAgendamiento($tabla, $item, $valor){
	...
	static public function mdlEditarAgendamiento($tabla, $datos){
	...
	static public function mdlEliminarAgendamiento($tabla, $datos){
	...
	static public function mdlActualizarAgendamiento($tabla, $item1, $valor1, $valor){
