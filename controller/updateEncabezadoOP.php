...
$query = "INSERT INTO ordenesencabezado (OVOP_ID,RelcRut,RelcExtranjero,OVOPFormaPago,OVOPFechaIngreso,OVOPTotalNeto,OVOPIVA,OVOPOtrosImpuestos,OVOPTotal,OVOPDireccionDespacho,OVOPFechaDespacho,OVOPDescripcion,OVOPEstado,Rel_CodSuc)VALUES('".$id_orden."', '".$cliente."','1','".$formapago."', '". date("Y-m-d", strtotime($fecha) )."', ".$total_neto.",".$total_iva.", ".$total_impto.",".$total_general.", '".$direccion_insert."', '".date("Y-m-d", strtotime($fecha_despacho) )."', '".$observacion_insert."', 'NUEVO', '".$sucursal."');";
