...
$sql = "select id, estado, fecha, rut_cliente, nombre_cliente, total_neto, total_impto, total, estado_erp, correlativo_erp, solicitante, fecha_erp from vw_ordenes_encabezado where trim(EmplrutF) = trim('$valida_id')";
...
if( !empty($requestData['search']['value']) ) {
	...
	$sql = "select id, estado, fecha, rut_cliente, nombre_cliente, total_neto, total_impto, total, estado_erp, correlativo_erp, solicitante, fecha_erp from vw_ordenes_encabezado ";
