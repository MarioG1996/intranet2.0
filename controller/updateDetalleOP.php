<?php
  include_once "../database/database_1.php";
    ...
    $query_insercion = "INSERT INTO ordenesdetalle (OVOPD_ID, OVOPD_CodigoProducto, OVOPD_Cantidad, OVOPD_PrecioNeto, OVOPD_SubTotal, OVOPD_PorcentajeDescuento, OVOPD_Total, OVOP_ID) VALUES($id_orden, '$prodcodigo', $cantidad, $subtotal_1, $subtotal_1, $descuento, $total_1, $id_orden);";
